...
class UserInputScannerClass{
    public static void main(String []args){
        ...
        // They Belongs to Scanner class and they are Non static => they'll get called using an Object
        // Why scanner class ? because in Java we can take input from internet, sockets (IP + Port number),
        // keyboard, files etc

        // So we've to connect with it
        // eg: if we take input with keyboard => Scanner s = new Scanner(System.in);
        // as taking input from Keyboard is represented by Object 'in' of System class in java
